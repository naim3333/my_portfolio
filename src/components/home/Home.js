            ...
            <div style={{ display: 'flex' }}>
                <div className="max-width">
                    <div className="home-content">
                        ...
                        <div><h1>
                            <a href="https://www.linkedin.com/in/md-naim-hossen-567679201/" class="typewrite" data-period="2000" data-type='[ "I am a MERN Stack Developer.", "I am a Next.js Developer", "I am a web developer" ]'>
